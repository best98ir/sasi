...
chats = {}
plugins = {}
litecyber_sudo = 434418436 -- ایدی سودوی اصلی را قرار دهید
GpsidSudo = -1001137329081
bot_id = 474987896 -- ایدی ربات را قرار دهید
helper_id =  490443764-- ایدی ربات api را قرار دهید
litecyberch = '@litecyber' -- یوزرنیم کانال خود را قرار دهید
litecyberby = '@sasan_cyber' -- یوزرنیم خود را قرار دهید
litecyberbybot = '@pv_sasanbot'  -- یوزرنیم پیام رسان خود را قرار دهید
paypinglink = 'sasan_cyber' -- لینک payping  خود را قرار دهید
paypingname = 'sasan_cyber' -- اسم خود را وارد نماید
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {490443760,474987896,434418436}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
